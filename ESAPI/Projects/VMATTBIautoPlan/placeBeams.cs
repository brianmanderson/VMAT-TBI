...
namespace VMATTBIautoPlan
{
    class placeBeams
    {
        ...
        public placeBeams(StructureSet ss, Tuple<int, DoseValue> presc, List<string> i, int iso, int vmatIso, bool appaPlan, int[] beams, string linac, string energy, string calcModel, bool flash, double overlapMargin)
        {
            selectedSS = ss;
            pi = selectedSS.Patient;
            prescription = presc;
